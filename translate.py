...
if __name__ == "__main__":
    ...
    epoch, model_chkpt, _, fields = load_chkpt(chkpt_file=cnf.chkpt_file, device=cnf.device)
    vocab = fields[0].vocab
    ...
    sos_idx = fields[0].vocab.stoi[fields[0].init_token]
    eos_idx = fields[0].vocab.stoi[fields[0].eos_token]

    translator = Translator(model=nmtmodel,
