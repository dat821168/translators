...
class BahdanauAttention(nn.Module):
    def __init__(self, config, query_size: int, key_size: int, num_units: int, normalize: bool = False):
        """
          Module: Bahdanau Attention
          Name: "Neural Machine Translation by Jointly Learning to Align and Translates"
        ...
        nn.init.uniform_(self.linear_q.weight.data, -config.init_weight, config.init_weight)
        nn.init.uniform_(self.linear_k.weight.data, -config.init_weight, config.init_weight)
        ...
        self.reset_parameters(config.init_weight)
